...
export const SSFCampList: Camp[] = [
	{
		...
		club: { imageSrc: '/club/iris.png', color: '#5B80D7', name: 'IRIS', description: 'AI/IoT 동아리' },
		department: 'security'
	},
    {
		thumbnail: '/camp/teamlog.png',
		name: 'JS로 감옥 탈출 게임 만들래 말래? 재밌어 보이긴 해 ~',
		club: { imageSrc: '/club/teamlog.png', color: '#EA3E45', name: 'TeamLog', description: '서버 프로그래밍 동아리' },
		department: 'security'
	},
    {
	...
	},
    {
		...
		name: '나만의 싸이월드 만들기',
		club: { imageSrc: '/club/ana.png', color: '#334882', name: 'AnA', description: '서버 동아리' },
		department: 'software'
	},
        {
		thumbnail: '/camp/creal.png',
		name: 'Unity로 만드는 교내전투 로그라이크 게임',
		club: { imageSrc: '/club/creal.png', color: '#1DD8D6', name: 'C,real', description: '게임 동아리' },
		department: 'software'
	},
    {
		thumbnail: '/camp/tapie.png',
		name: '웹으로 만드는 나만의 수박게임',
		club: { imageSrc: '/club/tapie.png', color: '#000000', name: 'TAPIE', description: '웹/앱 동아리' },
		department: 'software'
	},
    {
		thumbnail: '/camp/para.png',
		name: '내 기분에 따라 플레이리스트를 추천해주는 AI 만들기',
		club: { imageSrc: '/club/para.png', color: '#9966FF', name: 'PARA', description: 'AI 동아리' },
		department: 'software'
	},
];
